...
export const CATEGORIES: ICATEGORIES = {
  income: [
    {
      ...
      name_en: 'Salary',
      name_ko: '급여',
      icon: '/icon/salary.webp',
    },
    {
      category_key: 'BONUS',
      name_en: 'Bonus',
      name_ko: '상여금',
      icon: '/icon/bonus.webp',
    },
    {
      category_key: 'ALLOWANCE',
      name_en: 'Allowance',
      name_ko: '용돈',
      icon: '/icon/allowance.webp',
    },
    {
      category_key: 'SIDE_JOB',
      name_en: 'Side Job',
      name_ko: '부업',
      icon: '/icon/side-job.webp',
    },
    {
      category_key: 'PART_TIME',
      name_en: 'Part-time',
      name_ko: '아르바이트',
      icon: '/icon/part-time.webp',
    },
    {
      category_key: 'BUSINESS_INCOME',
      name_en: 'Business Income',
      name_ko: '사업수익',
      icon: '/icon/business-income.webp',
    },
    {
      category_key: 'INVESTMENT_INCOME',
      name_en: 'Investment Income',
      name_ko: '금융수익',
      icon: '/icon/investment-income.webp',
    },
    {
      category_key: 'INSURANCE',
      name_en: 'Insurance',
      name_ko: '보험금',
      icon: '/icon/insurance.webp',
    },
    {
      category_key: 'SCHOLARSHIP',
      name_en: 'Scholarship',
      name_ko: '장학금',
      icon: '/icon/scholarship.webp',
    },
    {
      category_key: 'REAL_ESTATE',
      name_en: 'Real Estate',
      name_ko: '부동산',
      icon: '/icon/real-estate.webp',
    },
    {
      category_key: 'RESALE',
      name_en: 'Resale',
      name_ko: '중고거래',
      icon: '/icon/resale.webp',
    },
    {
      category_key: 'DUTCH_PAY',
      name_en: 'Dutch Pay',
      name_ko: '더치페이',
      icon: '/icon/dutch-pay.webp',
    },
    {
  ...
  expense: [
    ...
    },
    {
      ...
      name_en: 'Transport',
      name_ko: '교통',
      icon: '/icon/transport.webp',
    },
    {
      category_key: 'CULTURE',
      name_en: 'Culture/Leisure',
      name_ko: '문화/여가',
      icon: '/icon/culture.webp',
    },
    {
      category_key: 'SHOPPING',
      name_en: 'Shopping',
      name_ko: '쇼핑',
      icon: '/icon/shopping.webp',
    },
    {
      category_key: 'BEAUTY',
      name_en: 'Beauty',
      name_ko: '미용',
      icon: '/icon/beauty.webp',
    },
    {
      category_key: 'MEDICAL',
      name_en: 'Medical',
      name_ko: '의료',
      icon: '/icon/medical.webp',
    },
    {
      category_key: 'EVENT',
      name_en: 'Event',
      name_ko: '경조',
      icon: '/icon/event.webp',
    },
    {
      category_key: 'EDUCATION',
      name_en: 'Education',
      name_ko: '교육',
      icon: '/icon/education.webp',
    },
    {
      category_key: 'CHILDCARE',
      name_en: 'Childcare',
      name_ko: '육아',
      icon: '/icon/childcare.webp',
    },
    {
      category_key: 'HOUSING',
      name_en: 'Housing',
      name_ko: '주거',
      icon: '/icon/housing.webp',
    },
    {
      category_key: 'SUBSCRIPTION',
      name_en: 'Telecom/Subscription',
      name_ko: '통신/구독',
      icon: '/icon/subscription.webp',
    },
    {
      category_key: 'PET',
      name_en: 'Pet',
